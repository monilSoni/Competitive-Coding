...
// Here we have not used erase in the solution because it has the complexity O(n) which makes the loop O(n^2). Instead we have created an entirely new array and returned it as result. 
